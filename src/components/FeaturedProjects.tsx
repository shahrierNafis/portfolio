...
const list = [
  ...
  },
  {
    ...
    description:
      "This is a social media website, supposed to mimic facebook, build with next.js, firebase and zustand, with it you can post, comment, add reactions and message with other users.",
    descriptionStyle: "",
  ...
  },
  {
    ...
    descriptionStyle: "",
    description:
      "This is a game to test you memory. when you press the start button, a grid of 12 cards will appear, and you need to click all the cards, but the cards will rearrange each time you click them and if you pick the same card twice, you lose.",
